...
本项目基于 vueAdmin-template

定制主题见 [https://github.com/php-cpm/custom-element-theme](https://github.com/php-cpm/custom-element-theme)

项目开发： php-cpm (zougangmu@qq.com)

## npm 配置
开发环境在用户目录下创建`.npmrc`文件，参考如下配置，以便提高安装依赖效率
...
```
# 后端接口代理地址配置 config/index.js

   http://localhost:7780/admin/api/*
